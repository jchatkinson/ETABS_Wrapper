...
namespace ETABSv1
{
    public static class cDCoHong_Kong_CP_2013Extension
    {
		public static (double Value, bool ProgDet)
		    GetOverwrite(this cDCoHong_Kong_CP_2013 obj, string Name, int Item) {
			double Value;
		...
		public static double
		    GetPreference(this cDCoHong_Kong_CP_2013 obj, int Item) {
			double Value;
			Value = default(double);
