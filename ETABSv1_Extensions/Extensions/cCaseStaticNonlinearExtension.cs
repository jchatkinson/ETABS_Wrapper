...
namespace ETABSv1
{
    public static class cCaseStaticNonlinearExtension
    {
		...
		public static (int LoadControl, int DispType, double Displ, int Monitor, int DOF, string PointName, string GDispl)
		...
		public static (int NumberLoads, string[] LoadType, string[] LoadName, double[] SF)
		...
		public static (bool SaveMultipleSteps, int MinSavedStates, int MaxSavedStates, bool PositiveOnly)
