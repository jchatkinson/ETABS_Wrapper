...
namespace ETABSv1
{
    public static class cSapModelExtension
    {
		public static double
		    GetMergeTol(this cSapModel obj) {
			double MergeTol;
			MergeTol = default(double);
		    var res = obj.GetMergeTol(ref MergeTol);
		    return MergeTol;
		}
		public static (string ProgramName, string ProgramVersion, string ProgramLevel)
		    GetProgramInfo(this cSapModel obj) {
			string ProgramName, ProgramVersion, ProgramLevel;
			ProgramName = ProgramVersion = ProgramLevel = default(string);
		    var res = obj.GetProgramInfo(ref ProgramName, ref ProgramVersion, ref ProgramLevel);
		    return (ProgramName, ProgramVersion, ProgramLevel);
		}
		public static (int NumberItems, string[] Item, string[] Data)
		    GetProjectInfo(this cSapModel obj) {
			int NumberItems;
		...
		public static (string Version, double MyVersionNumber)
		    GetVersion(this cSapModel obj) {
			string Version;
		...
		public static (eForce forceUnits, eLength lengthUnits, eTemperature temperatureUnits)
		...
		public static (eForce forceUnits, eLength lengthUnits, eTemperature temperatureUnits)
		    GetPresentUnits_2(this cSapModel obj) {
			eForce forceUnits;
			forceUnits = default(eForce);
			eLength lengthUnits;
			lengthUnits = default(eLength);
		...
		public static bool
		    TreeIsUpdateSuspended(this cSapModel obj) {
			bool IsSuspended;
