...
namespace ETABSv1
{
    ...
    {
		public static (int NumberLinks, string[] LinkNames, int[] LinkAxialDirs, double[] LinkAngles)
		    GetLinks(this cPropPointSpring obj, string Name) {
			int NumberLinks;
		...
		public static (int NumberNames, string[] MyName)
		    GetNameList(this cPropPointSpring obj) {
			int NumberNames;
		...
		public static (int SpringOption, double[] k, string CSys, string SoilProfile, string Footing, double Period, int color, string notes, string iGUID)
		    GetPointSpringProp(this cPropPointSpring obj, string Name) {
