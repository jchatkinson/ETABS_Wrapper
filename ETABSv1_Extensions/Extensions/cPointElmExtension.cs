...
namespace ETABSv1
{
    ...
    {
		public static int
		    CountConstraint(this cPointElm obj, string Name = "") {
			int Count;
			Count = default(int);
		...
		public static int
		    CountLoadDispl(this cPointElm obj, string Name = "", string LoadPat = "") {
			int Count;
			Count = default(int);
		...
		public static int
		    CountLoadForce(this cPointElm obj, string Name = "", string LoadPat = "") {
			int Count;
			Count = default(int);
		...
		public static (int NumberItems, int[] ObjectType, string[] ObjectName, int[] PointNumber)
		    GetConnectivity(this cPointElm obj, string Name) {
			int NumberItems;
		...
		public static (int NumberItems, string[] PointName, string[] ConstraintName)
		...
		public static (double X, double Y, double Z)
		    GetCoordCartesian(this cPointElm obj, string Name, string CSys = "Global") {
			double X, Y, Z;
		...
		public static (double A, double B, double C)
		    GetLocalAxes(this cPointElm obj, string Name) {
			double A, B, C;
		...
		public static (int NumberNames, string[] MyName)
		    GetNameList(this cPointElm obj) {
			int NumberNames;
		...
		public static (string Obj, int ObjType)
		    GetObj(this cPointElm obj, string Name) {
			string Obj;
			Obj = default(string);
			int ObjType;
			ObjType = default(int);
		...
		public static double
		    GetPatternValue(this cPointElm obj, string Name, string PatternName) {
			double Value;
		...
		public static bool[]
		    GetRestraint(this cPointElm obj, string Name) {
			bool[] Value;
			Value = default(bool[]);
		...
		public static double[]
		    GetSpring(this cPointElm obj, string Name) {
			double[] K;
			K = default(double[]);
		...
		public static double[]
		    GetSpringCoupled(this cPointElm obj, string Name) {
			double[] K;
			K = default(double[]);
		...
		public static double[]
		    GetTransformationMatrix(this cPointElm obj, string Name) {
			double[] Value;
			Value = default(double[]);
		...
		public static bool
		    IsSpringCoupled(this cPointElm obj, string Name) {
			bool IsCoupled;
