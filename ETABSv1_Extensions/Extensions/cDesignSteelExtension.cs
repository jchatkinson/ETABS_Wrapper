...
namespace ETABSv1
{
    public static class cDesignSteelExtension
    {
		...
		public static (int NumberItems, string[] FrameName, eFrameDesignOrientation[] FrameType, string[] DesignSect, string[] Status, string[] PMMCombo, double[] PMMRatio, double[] PRatio, double[] MMajRatio, double[] MMinRatio, string[] VMajCombo, double[] VMajRatio, string[] VMinCombo, double[] VMinRatio)
		    GetSummaryResults_3(this cDesignSteel obj, string Name, eItemType ItemType = eItemType.Objects) {
			int NumberItems;
			NumberItems = default(int);
			...
			double[] PMMRatio, PRatio, MMajRatio, MMinRatio, VMajRatio, VMinRatio;
			PMMRatio = PRatio = MMajRatio = MMinRatio = VMajRatio = VMinRatio = default(double[]);
		    var res = obj.GetSummaryResults_3(Name, ref NumberItems, ref FrameName, ref FrameType, ref DesignSect, ref Status, ref PMMCombo, ref PMMRatio, ref PRatio, ref MMajRatio, ref MMinRatio, ref VMajCombo, ref VMajRatio, ref VMinCombo, ref VMinRatio, ItemType);
