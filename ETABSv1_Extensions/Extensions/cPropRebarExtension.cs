...
namespace ETABSv1
{
    public static class cPropRebarExtension
    {
		public static (int NumberNames, string[] MyName)
		    GetNameList(this cPropRebar obj) {
			int NumberNames;
		...
		public static (double Area, double Diameter)
		    GetRebarProps(this cPropRebar obj, string Name) {
			double Area, Diameter;
			Area = Diameter = default(double);
		    var res = obj.GetRebarProps(Name, ref Area, ref Diameter);
		    return (Area, Diameter);
		}
		public static (double Area, double Diameter, string MyGUID)
		    GetRebarPropsWithGUID(this cPropRebar obj, string Name) {
			double Area, Diameter;
			Area = Diameter = default(double);
			string MyGUID;
		...
		public static (int NumberNames, string[] MyName, double[] Areas, double[] Diameters, string[] MyGUID)
		    GetNameListWithData(this cPropRebar obj) {
			int NumberNames;
			NumberNames = default(int);
