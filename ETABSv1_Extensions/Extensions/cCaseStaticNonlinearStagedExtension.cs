...
namespace ETABSv1
{
    ...
    {
		public static int
		    GetGeometricNonlinearity(this cCaseStaticNonlinearStaged obj, string Name) {
			int NLGeomType;
		...
		public static int
		    GetHingeUnloading(this cCaseStaticNonlinearStaged obj, string Name) {
			int UnloadType;
		...
		public static string
		    GetInitialCase(this cCaseStaticNonlinearStaged obj, string Name) {
			string InitialCase;
		...
		public static bool
		    GetMaterialNonlinearity(this cCaseStaticNonlinearStaged obj, string Name) {
			bool TimeDepMatProp;
			TimeDepMatProp = default(bool);
		    var res = obj.GetMaterialNonlinearity(Name, ref TimeDepMatProp);
		    return TimeDepMatProp;
		}
		public static (int StagedSaveOption, int StagedMinSteps, int StagedMinStepsTD)
		    GetResultsSaved(this cCaseStaticNonlinearStaged obj, string Name) {
		...
		public static (int MaxTotalSteps, int MaxFailedSubSteps, int MaxIterCS, int MaxIterNR, double TolConvD, bool UseEventStepping, double TolEventD, int MaxLineSearchPerIter, double TolLineSearch, double LineSearchStepFact)
		    GetSolControlParameters(this cCaseStaticNonlinearStaged obj, string Name) {
		...
		public static (int Stage, int NumberOperations, int[] Operation, string[] GroupName, int[] Age, string[] LoadType, string[] LoadName, double[] SF)
		    GetStageData(this cCaseStaticNonlinearStaged obj, string Name) {
		...
		public static (int Stage, int NumberOperations, int[] Operation, string[] ObjectType, string[] ObjectName, int[] Age, string[] MyType, string[] MyName, double[] SF)
		    GetStageData_1(this cCaseStaticNonlinearStaged obj, string Name) {
			int Stage, NumberOperations;
			Stage = NumberOperations = default(int);
			int[] Operation, Age;
			Operation = Age = default(int[]);
		...
		public static (int NumberStages, int[] Duration, string[] Comment)
		    GetStageDefinitions(this cCaseStaticNonlinearStaged obj, string Name) {
			int NumberStages;
		...
		public static (int NumberStages, int[] Duration, bool[] Output, string[] OutputName, string[] Comment)
		    GetStageDefinitions_1(this cCaseStaticNonlinearStaged obj, string Name) {
			int NumberStages;
			NumberStages = default(int);
			int[] Duration;
			Duration = default(int[]);
		...
		public static (double TolConvF, int MaxIter, double AccelFact, bool NoStop)
		    GetTargetForceParameters(this cCaseStaticNonlinearStaged obj, string Name) {
		...
		public static string
		    GetMassSource(this cCaseStaticNonlinearStaged obj, string Name) {
			string mSource;
			mSource = default(string);
		    var res = obj.GetMassSource(Name, ref mSource);
		    return mSource;
		}
		public static (int Stage, int NumberOperations, int[] Operation, string[] ObjectType, string[] ObjectName, double[] Age, string[] MyType, string[] MyName, double[] SF)
		    GetStageData_2(this cCaseStaticNonlinearStaged obj, string Name) {
			int Stage, NumberOperations;
			Stage = NumberOperations = default(int);
			int[] Operation;
		...
		public static (int NumberStages, double[] Duration, bool[] Output, string[] OutputName, string[] Comment)
		    GetStageDefinitions_2(this cCaseStaticNonlinearStaged obj, string Name) {
			int NumberStages;
			NumberStages = default(int);
			double[] Duration;
