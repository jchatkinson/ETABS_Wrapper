...
namespace ETABSv1
{
    public static class cFrameObjExtension
    {
		...
		public static (int NumberHinges, int[] HingeNum, string[] Prop, int[] MyType, int[] Behavior, string[] Source, eHingeLocationType[] LocType, double[] RD, double[] AD)
		    GetHingeAssigns_1(this cFrameObj obj, string Name) {
			int NumberHinges;
			NumberHinges = default(int);
			int[] HingeNum, MyType, Behavior;
			HingeNum = MyType = Behavior = default(int[]);
			string[] Prop, Source;
			Prop = Source = default(string[]);
			eHingeLocationType[] LocType;
			LocType = default(eHingeLocationType[]);
			double[] RD, AD;
			RD = AD = default(double[]);
		    var res = obj.GetHingeAssigns_1(Name, ref NumberHinges, ref HingeNum, ref Prop, ref MyType, ref Behavior, ref Source, ref LocType, ref RD, ref AD);
		    return (NumberHinges, HingeNum, Prop, MyType, Behavior, Source, LocType, RD, AD);
		}
		...
		public static (int CardinalPoint, bool Mirror2, bool Mirror3, bool StiffTransform, double[] Offset1, double[] Offset2, string CSys)
		    GetInsertionPoint_1(this cFrameObj obj, string Name) {
			int CardinalPoint;
			CardinalPoint = default(int);
			bool Mirror2, Mirror3, StiffTransform;
			Mirror2 = Mirror3 = StiffTransform = default(bool);
			double[] Offset1, Offset2;
			Offset1 = Offset2 = default(double[]);
			string CSys;
			CSys = default(string);
		    var res = obj.GetInsertionPoint_1(Name, ref CardinalPoint, ref Mirror2, ref Mirror3, ref StiffTransform, ref Offset1, ref Offset2, ref CSys);
		...
		public static string
		    GetTypeOAPI(this cFrameObj obj, string Name) {
			string MyType;
		...
		public static (int NumberGroups, string[] Groups)
		    GetGroupAssign(this cFrameObj obj, string Name) {
			int NumberGroups;
		...
		public static (int CurveType, double Tension, int NumPnts, double[] gx, double[] gy, double[] gz)
		    GetCurved_2(this cFrameObj obj, string Name) {
			int CurveType, NumPnts;
			CurveType = NumPnts = default(int);
			double Tension;
			Tension = default(double);
			double[] gx, gy, gz;
			gx = gy = gz = default(double[]);
		    var res = obj.GetCurved_2(Name, ref CurveType, ref Tension, ref NumPnts, ref gx, ref gy, ref gz);
		    return (CurveType, Tension, NumPnts, gx, gy, gz);
		}
