...
namespace ETABSv1
{
    public static class cDStSP16_13330_2017Extension
    {
		public static (double Value, bool ProgDet)
		    GetOverwrite(this cDStSP16_13330_2017 obj, string Name, int Item) {
			double Value;
		...
		public static double
		    GetPreference(this cDStSP16_13330_2017 obj, int Item) {
			double Value;
			Value = default(double);
