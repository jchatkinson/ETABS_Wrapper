...
namespace ETABSv1
{
    public static class cDStCanadian_S16_19Extension
    {
		public static (double Value, bool ProgDet)
		    GetOverwrite(this cDStCanadian_S16_19 obj, string Name, int Item) {
			double Value;
		...
		public static double
		    GetPreference(this cDStCanadian_S16_19 obj, int Item) {
			double Value;
			Value = default(double);
