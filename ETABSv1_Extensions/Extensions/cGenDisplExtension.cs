...
namespace ETABSv1
{
    ...
    {
		public static int
		    CountPoint(this cGenDispl obj, string Name) {
			int Count;
			Count = default(int);
		...
		public static (int NumberNames, string[] MyName)
		    GetNameList(this cGenDispl obj) {
			int NumberNames;
		...
		public static (int NumberItems, string[] PointName, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3)
		    GetPoint(this cGenDispl obj, string Name) {
			int NumberItems;
		...
		public static int
		    GetTypeOAPI(this cGenDispl obj, string name) {
			int MyType;
			MyType = default(int);
		...
		public static int
		    GetTypeGenDispl(this cGenDispl obj, string Name) {
			int MyType;
			MyType = default(int);
