...
namespace ETABSv1
{
    ...
    {
		public static (bool[] DOF, bool[] Fixed, bool[] Nonlinear, double[] Ke, double[] Ce, double[] K, double[] C, double[] CExp, double DJ2, double DJ3, string Notes, string GUID)
		...
		public static (bool[] DOF, bool[] Fixed, bool[] Nonlinear, double[] Ke, double[] Ce, double[] K, double[] Slow, double[] Fast, double[] Rate, double[] Radius, double Damping, double DJ2, double DJ3, string Notes, string GUID)
		...
		public static (bool[] DOF, bool[] Fixed, bool[] Nonlinear, double[] Ke, double[] Ce, double[] K, double[] Dis, double DJ2, double DJ3, string Notes, string GUID)
		    GetGap(this cPropLink obj, string Name) {
			bool[] DOF, Fixed, Nonlinear;
			DOF = Fixed = Nonlinear = default(bool[]);
			double[] Ke, Ce, K, Dis;
		...
		public static (bool[] DOF, bool[] Fixed, bool[] Nonlinear, double[] Ke, double[] Ce, double[] K, double[] Dis, double DJ2, double DJ3, string Notes, string GUID)
		    GetHook(this cPropLink obj, string Name) {
			bool[] DOF, Fixed, Nonlinear;
			DOF = Fixed = Nonlinear = default(bool[]);
			double[] Ke, Ce, K, Dis;
			Ke = Ce = K = Dis = default(double[]);
		...
		public static (bool[] DOF, bool[] Fixed, double[] Ke, double[] Ce, double DJ2, double DJ3, bool KeCoupled, bool CeCoupled, string Notes, string GUID)
		...
		public static (bool[] DOF, bool[] Fixed, bool[] Nonlinear, double[] Ke, double[] Ce, double DJ2, double DJ3, string Notes, string GUID)
		    GetMultiLinearElastic(this cPropLink obj, string Name) {
			bool[] DOF, Fixed, Nonlinear;
			DOF = Fixed = Nonlinear = default(bool[]);
			double[] Ke, Ce;
			Ke = Ce = default(double[]);
		...
		public static (int NumberPoints, double[] F, double[] D, int MyType, double A1, double A2, double B1, double B2, double Eta)
		...
		public static (bool[] DOF, bool[] Fixed, bool[] Nonlinear, double[] Ke, double[] Ce, double[] K, double[] Yield, double[] Ratio, double[] Exp, double DJ2, double DJ3, string Notes, string GUID)
		    GetPlasticWen(this cPropLink obj, string Name) {
			bool[] DOF, Fixed, Nonlinear;
			DOF = Fixed = Nonlinear = default(bool[]);
		...
		public static (bool[] DOF, bool[] Fixed, bool[] Nonlinear, double[] Ke, double[] Ce, double[] K, double[] Yield, double[] Ratio, double DJ2, double DJ3, string Notes, string GUID)
		...
		public static (double DefinedForThisLength, double DefinedForThisArea)
		...
		public static (bool[] DOF, bool[] Fixed, bool[] Nonlinear, double[] Ke, double[] Ce, double[] K, double[] Slow, double[] Fast, double[] Rate, double[] Radius, double[] SlowT, double[] FastT, double[] RateT, double Kt, double Dis, double Dist, double Damping, double DJ2, double DJ3, string Notes, string GUID)
		    GetTCFrictionIsolator(this cPropLink obj, string Name) {
			bool[] DOF, Fixed, Nonlinear;
			DOF = Fixed = Nonlinear = default(bool[]);
		...
		public static (double W, double M, double R1, double R2, double R3)
		...
		public static (bool[] dof, bool[] Fixed, bool[] Nonlinear, double[] ke, double[] ce, double[] k, double[] c, double[] CY, double[] ForceLimit, double dj2, double dj3, string notes, string GUID)
		...
		public static (bool[] dof, bool[] Fixed, bool[] Nonlinear, double[] ke, double[] ce, double[] k, double[] K1, double[] K2, double[] u0, double[] us, int[] direction, double dj2, double dj3, string notes, string GUID)
		...
		public static (int AcceptanceType, bool Symmetric, bool[] Active, double[] IOPos, double[] LSPos, double[] CPPos, double[] IONeg, double[] LSNeg, double[] CPNeg)
		    GetAcceptanceCriteria(this cPropLink obj, string Name) {
			int AcceptanceType;
			AcceptanceType = default(int);
			bool Symmetric;
			Symmetric = default(bool);
			bool[] Active;
			Active = default(bool[]);
			double[] IOPos, LSPos, CPPos, IONeg, LSNeg, CPNeg;
			IOPos = LSPos = CPPos = IONeg = LSNeg = CPNeg = default(double[]);
		    var res = obj.GetAcceptanceCriteria(Name, ref AcceptanceType, ref Symmetric, ref Active, ref IOPos, ref LSPos, ref CPPos, ref IONeg, ref LSNeg, ref CPNeg);
		    return (AcceptanceType, Symmetric, Active, IOPos, LSPos, CPPos, IONeg, LSNeg, CPNeg);
		}
