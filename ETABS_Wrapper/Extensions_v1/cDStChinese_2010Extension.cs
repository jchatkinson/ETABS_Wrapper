...
namespace ETABSv1
{
    public static class cDStChinese_2010Extension
    {
		public static (double Value, bool ProgDet)
		    GetOverwrite(this cDStChinese_2010 obj, string Name, int Item) {
			double Value;
		...
		public static double
		    GetPreference(this cDStChinese_2010 obj, int Item) {
			double Value;
			Value = default(double);
