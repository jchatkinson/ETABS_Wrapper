...
namespace ETABSv1
{
    public static class cLinkObjExtension
    {
		public static string
		    AddByCoord(this cLinkObj obj, double XI, double YI, double ZI, double XJ, double YJ, double ZJ, bool IsSingleJoint = false, string PropName = "Default", string UserName = "", string CSys = "Global") {
			string Name;
			Name = default(string);
		...
		public static string
		    AddByPoint(this cLinkObj obj, string Point1, string Point2, bool IsSingleJoint = false, string PropName = "Default", string UserName = "") {
			string Name;
			Name = default(string);
		...
		public static string
		    GetElm(this cLinkObj obj, string Name) {
			string Elm;
			Elm = default(string);
		...
		public static string
		    GetGUID(this cLinkObj obj, string Name) {
			string GUID;
			GUID = default(string);
		...
		public static (double Ang, bool Advanced)
		    GetLocalAxes(this cLinkObj obj, string Name) {
			double Ang;
			Ang = default(double);
			bool Advanced;
		...
		public static (bool Active, int AxVectOpt, string AxCSys, int[] AxDir, string[] AxPt, double[] AxVect, int Plane2, int PlVectOpt, string PlCSys, int[] PlDir, string[] PlPt, double[] PlVect)
		    GetLocalAxesAdvanced(this cLinkObj obj, string Name) {
			bool Active;
			Active = default(bool);
		...
		public static (string Point1, string Point2)
		    GetPoints(this cLinkObj obj, string Name) {
		...
		public static string
		    GetProperty(this cLinkObj obj, string Name) {
			string PropName;
		...
		public static bool
		    GetSelected(this cLinkObj obj, string Name) {
			bool Selected;
		...
		public static double[]
		    GetTransformationMatrix(this cLinkObj obj, string Name, bool IsGlobal = true) {
			double[] Value;
		...
		public static (int NumberGroups, string[] Groups)
		    GetGroupAssign(this cLinkObj obj, string Name) {
			int NumberGroups;
		...
		public static (int NumberNames, string[] MyName)
		    GetNameListOnStory(this cLinkObj obj, string StoryName) {
			int NumberNames;
			NumberNames = default(int);
			string[] MyName;
			MyName = default(string[]);
