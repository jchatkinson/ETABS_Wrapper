...
namespace ETABSv1
{
    public static class cDCoAS_3600_2018Extension
    {
		public static (double Value, bool ProgDet)
		    GetOverwrite(this cDCoAS_3600_2018 obj, string Name, int Item) {
			double Value;
		...
		public static double
		    GetPreference(this cDCoAS_3600_2018 obj, int Item) {
			double Value;
			Value = default(double);
