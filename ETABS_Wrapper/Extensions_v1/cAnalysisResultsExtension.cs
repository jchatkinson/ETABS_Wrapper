...
namespace ETABSv1
{
    public static class cAnalysisResultsExtension
    {
		...
		public static (int NumberResults, string[] obj, string[] elm, string[] PointElm, string[] LoadCase, string[] StepType, double[] StepNum, double[] e11top, double[] e22top, double[] g12top, double[] emaxtop, double[] emintop, double[] eangletop, double[] evmtop, double[] e11bot, double[] e22bot, double[] g12bot, double[] emaxbot, double[] eminbot, double[] eanglebot, double[] evmbot, double[] g13avg, double[] g23avg, double[] gmaxavg, double[] gangleavg)
		    ...
		    var res = obj.AreaStrainShell(Name, ItemTypeElm, ref NumberResults, ref obj, ref elm, ref PointElm, ref LoadCase, ref StepType, ref StepNum, ref e11top, ref e22top, ref g12top, ref emaxtop, ref emintop, ref eangletop, ref evmtop, ref e11bot, ref e22bot, ref g12bot, ref emaxbot, ref eminbot, ref eanglebot, ref evmbot, ref g13avg, ref g23avg, ref gmaxavg, ref gangleavg);
		    return (NumberResults, obj, elm, PointElm, LoadCase, StepType, StepNum, e11top, e22top, g12top, emaxtop, emintop, eangletop, evmtop, e11bot, e22bot, g12bot, emaxbot, eminbot, eanglebot, evmbot, g13avg, g23avg, gmaxavg, gangleavg);
		}
		public static (int NumberResults, string[] obj, string[] elm, string[] Layer, int[] IntPtNum, double[] IntPtLoc, string[] PointElm, string[] LoadCase, string[] StepType, double[] StepNum, double[] E11, double[] E22, double[] G12, double[] EMax, double[] EMin, double[] EAngle, double[] EVM, double[] G13avg, double[] G23avg, double[] GMaxavg, double[] GAngleavg)
		    ...
		    var res = obj.AreaStrainShellLayered(Name, ItemTypeElm, ref NumberResults, ref obj, ref elm, ref Layer, ref IntPtNum, ref IntPtLoc, ref PointElm, ref LoadCase, ref StepType, ref StepNum, ref E11, ref E22, ref G12, ref EMax, ref EMin, ref EAngle, ref EVM, ref G13avg, ref G23avg, ref GMaxavg, ref GAngleavg);
		    return (NumberResults, obj, elm, Layer, IntPtNum, IntPtLoc, PointElm, LoadCase, StepType, StepNum, E11, E22, G12, EMax, EMin, EAngle, EVM, G13avg, G23avg, GMaxavg, GAngleavg);
		}
